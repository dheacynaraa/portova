        ...
        <div class="w-full max-w-md">
            ...
            <div class="card rounded-3xl p-8 md:p-10 border border-slate-700/30">
                ...
                <div class="text-center mb-8">
                    <h2 class="text-2xl font-semibold text-white">Buat Akun Baru</h2>
                    <p class="text-slate-400 text-sm mt-2">
                        Daftar untuk mulai berbagi karya proyek Anda.
                    </p>
                </div>

                <!-- Flash Message Success (dari redirect setelah register) -->
                @if(session('success'))
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <!-- Nama Lengkap -->
                    <div class="mb-6">
                        <label class="block text-xs font-medium text-cyan-400 mb-2 tracking-wider">NAMA LENGKAP</label>
                        <div class="relative">
                            <i class="bi bi-person input-icon input-icon-left"></i>
                            <input
                            type="text"
                            id="name"
                            name="name"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <i class="bi bi-envelope input-icon input-icon-left"></i>
                            <input
                                type="email"
                                id="email"
                                name="email"
                    ...
                    <!-- Kata Sandi -->
                    <div class="mb-6">
                        <label class="block text-xs font-medium text-cyan-400 mb-2 tracking-wider">KATA SANDI</label>
                        <div class="relative">
                            <i class="bi bi-lock input-icon input-icon-left"></i>
                            <input
                                type="password"
                                id="password"
                                name="password"
                    ...
                    <div class="mb-8">
                        <label class="block text-xs font-medium text-cyan-400 mb-2 tracking-wider">KONFIRMASI KATA SANDI</label>
                        <div class="relative">
                            <i class="bi bi-lock input-icon input-icon-left"></i>
                            <input
                                type="password"
                    ...
                    <button
                        type="submit"
                        class="w-full bg-cyan-500 hover:bg-cyan-400 active:scale-95 duration-200 transition text-slate-950 font-semibold py-4 rounded-2xl text-lg flex items-center justify-center gap-2 shadow-lg shadow-cyan-500/30">
                        Daftar Sekarang
                ...
                <div class="text-center mt-8">
                    <p class="text-slate-400 text-sm">
                        Sudah punya akun?
                        <a href="{{ route('login') }}" class="text-cyan-400 hover:text-cyan-300 font-medium transition-colors">Masuk di sini</a>
                    </p>
                </div>
            </div>
        </div>
